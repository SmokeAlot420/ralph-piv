...
```bash
# Solidity
cd PROJECT_PATH/contracts && forge build && forge test -vvv

# TypeScript
cd PROJECT_PATH/frontend && pnpm build && pnpm lint && npx tsc --noEmit

# Python
cd PROJECT_PATH && pytest tests/ -v
```
